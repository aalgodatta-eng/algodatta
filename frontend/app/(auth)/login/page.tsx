...
export default function LoginPage(){
  ...
  return (<div style={{minHeight:"100vh",display:"flex",justifyContent:"center",alignItems:"center"}}>
    <div style={{background:"#fff",padding:32,borderRadius:12,boxShadow:"0 4px 20px rgba(0,0,0,0.12)",textAlign:"center"}}>
      ...
      <p style={{marginBottom:16,opacity:.8}}>Dummy login for local testing</p>
      <button onClick={login} style={{width:"100%",padding:12,background:"#0c3c60",color:"#fff",border:"none",borderRadius:6}}>Login</button>
    </div></div>);
}
